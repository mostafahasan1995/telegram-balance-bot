 ...
 *
 * The components that draw all this (the backdrop, the header, the mark) are in `brand.tsx`. They
 * live apart from this file because a module React Fast Refresh can hot-swap must export nothing
 * but components.
 */
